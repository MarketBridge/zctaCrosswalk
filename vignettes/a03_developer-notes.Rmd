...
Note that while R has two built-in vectors that deal with state names (`state.abb` and `state.name`), they cannot help us for two reasons: (1) they do not contain FIPS codes and (2) they only contain 50 states.
